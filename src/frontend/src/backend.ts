...
import type { FileRecord as _FileRecord, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createFileRecord(arg0: string | null, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createFileRecord(to_candid_opt_n8(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFileRecord(arg0: string): Promise<FileRecord | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getFileRecord(arg0);
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FileRecord]): FileRecord | null {
    return value.length === 0 ? null : value[0];
}
